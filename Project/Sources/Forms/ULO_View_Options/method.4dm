C_LONGINT:C283($vl_FormEvent;$vl_Which)
...
Case of 
	: ($vl_FormEvent=On Load:K2:1)
		...
		ARRAY TEXT:C222(at_Colour_Style;6)
		...
		$vl_Which:=Find in array:C230(at_Colour_Style;<>vt_BRW_VIEW_STYLE)
		LISTBOX SELECT ROW:C912(*;"BRW_Styles";$vl_Which;lk replace selection:K53:1)
		If (<>vl_Browser_Listing_BG_Colour=0) & (<>vl_Browser_Listing_BG_AltColour=0)
			  //BRW_VIEW_SET_STYLE
			OBJECT SET RGB COLORS:C628(*;"brw_Preview_styles";0x0000;vl_BRW_Colour_1;vl_BRW_Colour_2)
		Else 
