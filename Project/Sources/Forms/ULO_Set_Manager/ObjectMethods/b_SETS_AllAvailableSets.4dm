  ...
  //OBJECT GET COORDINATES(*;"SETS_AllAvailableSets1";$vl_L;$vl_T;$vl_R;$vl_B)
  ...
  //If ($vt_Selected#"")
  //vl_SETS_Selected_1:=Num($vt_Selected)
  //at_SETS_AllAvailableSets{0}:=at_SETS_AllMySets{vl_SETS_Selected_1}
  //End if 