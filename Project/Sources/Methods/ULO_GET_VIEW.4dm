...
Else 
	...
	$e_view:=ds:C1482["uloData"].query("user == :1 & table == :2 & default == True & handle == :3 & type == 2";$1;$2;$3).first()
	If ($e_view=Null:C1517)
		  //If not found, get system default a.k.a userId = 0
		$e_view:=ds:C1482["uloData"].query("user == :1 & table == :2 & default == True & handle == :3 & type == 2";0;$2;$3).first()
		If ($e_view=Null:C1517)
