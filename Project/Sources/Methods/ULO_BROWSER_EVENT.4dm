...
Case of 
	: ($vt_eventObject="form")
		Case of 
			: ($vl_event=On Load:K2:1)
				...
				End if 
				READ PICTURE FILE:C678(Storage:C1525.prefs.logo; $vg_logo)
				Form:C1466.logo:=$vg_logo
				...
				EXECUTE METHOD:C1007(Storage:C1525.hostMethods.listFormEvent; *; $1)
	...
	: ($vt_eventObject="ULO_LIST")
		Case of 
			: ($vl_event=On Double Clicked:K2:5)
				//TRACE
				$vo_inputForm:=New object:C1471()
				//Use ($vo_inputForm)
				$vo_inputForm:=Form:C1466
				//End use 
				...
				If (Form:C1466.selectedRecord#Null:C1517)
					//Not sure about these two approaches
					EXECUTE METHOD:C1007($vt_method; *; Form:C1466.tableNumber; Form:C1466.navItem.handle; OB Copy:C1225($vo_inputForm))
					//CALL WORKER("INPUT"; $vt_method; Form.tableNumber; Form.navItem.handle; $vo_inputForm)
				End if 
